...
describe(['tagmobile'], 'Annotation tests.', function() {
	...
	it('Try to insert empty comment.', function() {
		...
		cy.cGet('#input-modal-input').should('have.text', '');
		cy.cGet('#response-ok').click();
		cy.cGet('#mobile-wizard .wizard-comment-box.oxool-annotation-content-wrapper').should('not.exist');
		cy.cGet('#mobile-wizard .wizard-comment-box .oxool-annotation-content').should('not.exist');
	});
	...
	it('Resolve comment.', function() {
		...
		cy.cGet('#mobile-wizard .wizard-comment-box .oxool-annotation-content-resolved').should('exist');
		cy.cGet('#mobile-wizard .wizard-comment-box .oxool-annotation-content-resolved').should('have.text', 'Resolved');
	});
});
