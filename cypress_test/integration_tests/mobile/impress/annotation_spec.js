...
describe(['tagmobile'], 'Annotation tests.', function() {
	...
	it('Saving comment.', function() {
		...
		cy.cGet('#mobile-wizard .wizard-comment-box .oxool-annotation-content')
	...
	it('Modifying comment.', function() {
		...
		cy.cGet('.oxool-annotation-table').should('exist');
	...
	it('Remove comment.', function() {
		...
		cy.cGet('#mobile-wizard .wizard-comment-box .oxool-annotation-content').should('have.text', 'some text');
	...
	it('Try to insert empty comment.', function() {
		...
		cy.cGet('#response-ok').click();
		cy.cGet('.oxool-annotation-content-wrapper.wizard-comment-box').should('not.exist');
		cy.cGet('#mobile-wizard .wizard-comment-box .oxool-annotation-content').should('not.exist');
	});
});
