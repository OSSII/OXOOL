...
describe(['tagdesktop', 'tagnextcloud', 'tagproxy'], 'Track Changes', function () {
	...
	it.skip('Accept All', function () {
		...
		cy.cGet('div.oxool-annotation').should('have.length', 3);

		cy.cGet('#comment-container-2').should('contain','some text1');
		cy.cGet('#comment-container-2 .oxool-annotation-menubar').click();
		...
		cy.cGet('div.oxool-annotation').should('have.length', 2);
