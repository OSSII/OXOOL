...
describe(['tagdesktop'], 'Annotation Tests', function() {
	...
	it('Insert', function() {
		...
		cy.cGet('.oxool-annotation-content-wrapper').should('exist');
	...
	it('Remove', function() {
		...
		cy.cGet('.oxool-annotation-content-wrapper').should('not.exist');
	});
...
describe(['tagdesktop'], 'Collapsed Annotation Tests', function() {
	...
	it('Modify', function() {
		...
		cy.cGet('.oxool-annotation-content-wrapper').should('exist');
		cy.cGet('#annotation-content-area-1').should('contain','some text0');
		cy.cGet('.oxool-annotation-img').click();
		cy.cGet('#comment-annotation-menu-1').click();
		cy.cGet('body').contains('.context-menu-item','Modify').click();
		cy.cGet('#annotation-modify-textarea-1').type('some other text, ');
		cy.cGet('#annotation-save-1').click();
...
describe(['tagdesktop'], 'Annotation Autosave Tests', function() {
	...
	it.skip('Reply autosave cancel', function() {
		...
		cy.cGet('#comment-container-1 .oxool-annotation-autosavelabel').should('be.not.visible');
		cy.cGet('#comment-container-2 .oxool-annotation-autosavelabel').should('not.exist');
