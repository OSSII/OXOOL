...
describe(['tagdesktop'], 'Annotation Tests', function() {
	...
	it('Insert', function() {
		...
		cy.cGet('.oxool-annotation-content > div').should('contain','some text');
	});
	...
	it('Modify', function() {
		...
		cy.cGet('.oxool-annotation-content-wrapper:visible .oxool-annotation-menu').click();
	...
	it('Reply',function() {
		...
		cy.cGet('.oxool-annotation-content > div').should('include.text','some reply text');
	});
});
...
describe(['tagdesktop'], 'Collapsed Annotation Tests', function() {
	...
	it('Modify', function() {
		...
		cy.cGet('.oxool-annotation-menu').click();
		cy.cGet('body').contains('.context-menu-item','Modify').click();
		cy.cGet('#annotation-modify-textarea-1').type('{home}');
		cy.cGet('#annotation-modify-textarea-1').type('some other text, ');
		cy.cGet('#annotation-save-1').click();
...
describe(['tagdesktop'], 'Annotation Autosave Tests', function() {
	...
	it('Insert autosave', function() {
		...
		cy.cGet('.leaflet-marker-icon').should('exist');
		cy.cGet('.oxool-annotation-content > div').should('have.text','Test Comment');
	});
	...
	it('Insert autosave save', function() {
		...
		cy.cGet('.oxool-annotation-edit.modify-annotation').should('be.not.visible');
		cy.cGet('.leaflet-marker-icon').should('exist');
		cy.cGet('.oxool-annotation-content > div').should('have.text','Test Comment');
	...
	it('Insert autosave cancel', function() {
		...
		cy.cGet('.oxool-annotation-edit.modify-annotation').should('not.exist');
		cy.cGet('.leaflet-marker-icon').should('not.exist');
		cy.cGet('.oxool-annotation-content > div').should('not.exist');
	...
	it('Modify autosave', function() {
		...
		helper.beforeAll(testFileName, 'impress', true, false, false, true);
		cy.cGet('.leaflet-marker-icon').should('exist');
		cy.cGet('.oxool-annotation-content > div').should('have.text','some other text, some text0');
	});
	...
	it('Modify autosave cancel', function() {
		...
		helper.beforeAll(testFileName, 'impress', true, false, false, true);
		cy.cGet('.leaflet-marker-icon').should('exist');
		cy.cGet('.oxool-annotation-content > div').should('have.text','some text0');
	});
	...
	it('Reply autosave',function() {
		...
		helper.closeDocument(testFileName, '');
		helper.beforeAll(testFileName, 'impress', true, false, false, true);
		cy.cGet('.oxool-annotation-edit.reply-annotation').should('be.not.visible');
		cy.cGet('.oxool-annotation-content > div').should('include.text','some reply text');
	});
	...
	it('Reply autosave save',function() {
		...
		cy.cGet('.oxool-annotation-autosavelabel').should('be.not.visible');
		cy.cGet('.oxool-annotation-edit.reply-annotation').should('be.not.visible');
		cy.cGet('.oxool-annotation-content > div').should('include.text','some text0');
		cy.cGet('.oxool-annotation-content > div').should('include.text','some reply text');
