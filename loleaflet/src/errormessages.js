...
errorMessages.unauthorized = _('You are not authorized to use, please contact your administrator.');
...
errorMessages.storage = {
	...
	code403: _('The file cannot be saved. Because the content of the file contains personal information or suspected sensitive information, it is recommended to adjust the content before saving.'),
