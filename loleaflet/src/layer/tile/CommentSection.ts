...
class Comment {
	...
	private createContainerAndWrapper () {
		...
		this.sectionProperties.collapsed = L.DomUtil.create('div', 'oxool-annotation-collapsed', this.sectionProperties.container);
	...
	private createAuthorTable () {
		...
		this.sectionProperties.replyCountNode = L.DomUtil.create('div', 'oxool-annotation-reply-count-collapsed', this.sectionProperties.collapsed);
