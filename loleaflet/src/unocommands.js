...
var unoCommandsArray = {
	...
	AddTextBox:{text:{menu:_('Add Text Box'),},},
	...
	AlphaListStyle:{text:{menu:_('Alphabet Uppercase List'),},},
	AlphaLowListStyle:{text:{menu:_('Alphabet Lowercase List'),},},
	AnchorMenu:{global:{menu:_('Anc~hor'),},},
	Arrange:{text:{menu:_('Arrange'),},},
	...
	BulletListStyle:{text:{menu:_('Bullet List'),},},
	...
	ChangePicture:{global:{menu:_('~Replace...'),},presentation:{menu:_('~Replace...'),},},
	ChangesMenu:{global:{menu:_('Track Chan~ges'),},},
	CharacterMenu:{text:{menu:_('C~haracter'),},},
	...
	DefaultCharStyle:{text:{menu:_('Default ~Character'),},},
	...
	EmphasisCharStyle:{text:{menu:_('E~mphasis'),},},
	...
	ExternalEdit:{global:{menu:_('Edit with External Tool'),},},
	FieldDialog:{text:{context:_('Edit F~ields...'),menu:_('F~ields...'),},},
	FilterMenu:{spreadsheet:{menu:_('More ~Filters'),},},
	FlipHorizontal:{global:{menu:_('Flip Horizontally'),},},
	FlipMenu:{global:{menu:_('F~lip'),},},
	...
	GraphicDialog:{text:{menu:_('~Graphic Properties...'),},},
	Group:{global:{menu:_('~Group...'),},},
	GroupOutlineMenu:{spreadsheet:{menu:_('~Group and Outline'),},},
	Grow:{global:{menu:_('Increase Size'),},},
	Heading1ParaStyle:{text:{menu:_('Heading ~1'),},},
	Heading2ParaStyle:{text:{menu:_('Heading ~2'),},},
	Heading3ParaStyle:{text:{menu:_('Heading ~3'),},},
	...
	InsertColumnDialog:{presentation:{menu:_('Insert Columns'),},text:{menu:_('~Columns...'),},},
	...
	InsertRowDialog:{presentation:{menu:_('Insert Rows'),},text:{menu:_('~Rows...'),},},
	...
	NumberListStyle:{text:{menu:_('Number List'),},},
	NumberingMenu:{text:{menu:_('~Bullets and Numbering'),},},
	...
	ParagraphMenu:{text:{menu:_('P~aragraph'),},},
	...
	PreformattedParaStyle:{text:{menu:_('Pre~formatted Text'),},},
	PreviousTrackedChange:{text:{menu:_('Pr~evious'),},},
	Print:{global:{menu:_('~Print...'),},},
	QuoteCharStyle:{text:{menu:_('Qu~otation'),},},
	...
	RomanListStyle:{text:{menu:_('Roman Uppercase List'),},},
	RomanLowListStyle:{text:{menu:_('Roman Lowercase List'),},},
	Rotate180:{text:{menu:_('Rotate 1~80°'),},},
	RotateFlipMenu:{global:{menu:_('Rot~ate or Flip'),},},
	...
	SetColumnWidth:{text:{menu:_('~Column Width...'),},},
	...
	SetMinimalColumnWidth:{presentation:{menu:_('Minimal Column Width'),},text:{menu:_('Minimize Column Width'),},},
	...
	SetRowHeight:{text:{menu:_('Row Height...'),},},
	...
	SourceCharStyle:{text:{menu:_('Sou~rce Text'),},},
	...
	StrongEmphasisCharStyle:{text:{menu:_('~Strong Emphasis'),},},
	StyleMenu:{global:{menu:_('St~yle'),},},
	...
	TableDialog:{presentation:{menu:_('~Properties...'),},text:{menu:_('~Table Properties...'),},},
	...
	TextBodyParaStyle:{text:{menu:_('Text Body'),},},
	ThesaurusDialog:{global:{menu:_('~Thesaurus...'),},text:{menu:_('~Thesaurus...'),},},
	ToggleMergeCells:{spreadsheet:{menu:_('M~erge and Center Cells'),},},
	ToggleObjectBezierMode:{global:{menu:_('Poi~nts'),},},
	ToggleObjectRotateMode:{global:{menu:_('~Rotate'),},},
