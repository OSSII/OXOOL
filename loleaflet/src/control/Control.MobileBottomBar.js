			...
			spreadsheet: [
				...
				{	// 列選單
					...
					items: [
						...
						{type: 'break'},
						{	// 凍結第一列
							id: 'freezepanesrow', text: _UNO('.uno:FreezePanesRow', docType), img: 'freezepanesrow', uno: '.uno:FreezePanesRow',
							stateChange: true
						},
					]
				},
				{	// 欄選單
					...
					items: [
						...
						{type: 'break'},
						{	// 凍結第一欄
							id: 'freezepanescolumn', text: _UNO('.uno:FreezePanesColumn', docType), img: 'freezepanescolumn', uno: '.uno:FreezePanesColumn',
							stateChange: true
						},
					]
				},
