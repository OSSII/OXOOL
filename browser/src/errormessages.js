...
var lang = window.oxoolParams.get('lang');
if (lang) {
	String.locale = lang;
} else {
	String.locale = 'en-US';
...
errorMessages.emptyhosturl = _('The host URL is empty. The oxoolwsd server is probably misconfigured, please contact the administrator.');
