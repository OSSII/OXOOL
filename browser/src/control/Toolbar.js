...
L.Map.include({
	...
	showLOAboutDialog: function() {
		...
		form.querySelector('#oxoolwsd-version').querySelector('a').focus();
	...
	copyVersionInfoToClipboard: function() {
		var text = 'OXOOLWSD version: ' + this.getVersionInfoFromClass('oxoolwsd-version') + '\n';
		text += 'LOKit version: ' + this.getVersionInfoFromClass('lokit-version') + '\n';
		text += 'Served by: ' + document.getElementById('os-info').innerText + '\n';
		text += 'Server ID: ' + document.getElementById('oxoolwsd-id').innerText + '\n';
