...
export class ColumnGroup extends GroupBase {
	_map: any;
	_sheetGeometry: oxool.SheetGeometry;
	_cornerHeaderWidth: number;
	_splitPos: oxool.Point;
	...
	update(): void {
		...
		this._splitPos = (this._map._docLayer._splitPanesContext as oxool.SplitPanesContext).getSplitPos();
...
L.Control.ColumnGroup = oxool.ColumnGroup;
