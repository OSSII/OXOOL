...
L.Control.StatusBar = L.Control.extend({
			...
			if (!window.mode.isMobile()) {
				statusbar.insert('left', [
					{type: 'break', id: 'break1'},
					{
						...
						html: '<div id="StatusDocPos" class="oxool-font" title="' + _('Number of Sheets') + '" style="padding: 5px 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</div>'
					},
					{type: 'break', id: 'break2'},
					{
						type: 'html', id: 'RowColSelCount',
						html: '<div id="RowColSelCount" class="oxool-font" title="' + _('Selected range of cells') + '" style="padding: 5px 5px;line-height:0;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</div>'
					},
					{type: 'break', id: 'break3', tablet: false},
					{
						type: 'html', id: 'InsertMode', mobile: false, tablet: false,
						html: '<div id="InsertMode" class="oxool-font insert-mode-true" title="' + _('Entering text mode') + '" style="padding: 5px 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</div>'
					},
					...
					{type: 'break', id: 'break5', tablet: false},
					{
						...
						html: '<div id="StatusSelectionMode" class="oxool-font" title="' + _('Selection Mode') + '" style="padding: 5px 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</div>'
					},
					{type: 'break', id: 'break8', mobile: false, tablet: false},
					{
						type: 'html', id: 'StateTableCell', mobile: false, tablet: false,
						html: '<div id="StateTableCell" class="oxool-font" title="' + _('Choice of functions') + '" style="padding: 5px 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</div>'
					},
					{
			...
			if (!window.mode.isMobile()) {
				statusbar.insert('left', [
					{type: 'break', id: 'break1'},
					{
						...
						html: '<div id="StatePageNumber" class="oxool-font" title="' + _('Number of Pages') + '" style="padding: 5px 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</div>'
					},
					{type: 'break', id: 'break2'},
					{
						type: 'html', id: 'StateWordCount', mobile: false, tablet: false,
						html: '<div id="StateWordCount" class="oxool-font" title="' + _('Word Counter') + '" style="padding: 5px 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</div>'
					},
			...
			if (!window.mode.isMobile()) {
				statusbar.insert('left', [
					{type: 'break', id: 'break1'},
					{
						...
						html: '<div id="PageStatus" class="oxool-font" title="' + _('Number of Slides') + '" style="padding: 5px 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</div>'
					},
	...
	onCommandStateChanged: function(e) {
		...
		if (commandName === '.uno:StatusDocPos') {
			...
			$('#InsertMode').addClass('oxool-font insert-mode-' + state);
