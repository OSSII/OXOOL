...
export class RowHeader extends oxool.Header {
	...
	onInitialize(): void {
		...
		this._headerInfo = new oxool.HeaderInfo(this._map, false /* isCol */);
	}
	...
	_getParallelPos (point: oxool.Point): number {
		return point.y;
	}

	_getOrthogonalPos (point: oxool.Point): number {
		return point.x;
	}
...
L.Control.RowHeader = oxool.RowHeader;

L.control.rowHeader = function (options?: oxool.HeaderExtraProperties) {
