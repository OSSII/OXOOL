...
export class ColumnHeader extends Header {
	...
	onInitialize(): void {
		...
		this._headerInfo = new oxool.HeaderInfo(this._map, true /* isCol */);
	}
...
L.Control.ColumnHeader = oxool.ColumnHeader;

L.control.columnHeader = function (options?: oxool.HeaderExtraProperties) {
