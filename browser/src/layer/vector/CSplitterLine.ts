...
class CSplitterLine extends CRectangle {
	...
	constructor(map: any, options: any) {
		super(new oxool.Bounds(undefined), options);
	...
	private computeBounds(): oxool.Bounds {
		...
		return new oxool.Bounds(start, end);
	}
}
