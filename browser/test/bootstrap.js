...
var oxoolwsd_options = debug ? {} : { stdio: 'ignore'};
const oxoolwsd = spawn(`${top_builddir}/oxoolwsd`, args, oxoolwsd_options);
...
function serverReady() {
    console.log('\nTest running - connect to:\n\n\t' +
		...
		'://localhost:9999/browser/1234/loleaflet.html?file_path=file://' +
...
function dumpMemoryUse() {
	var url = (ssl_flag === 'true' ? 'https' : 'http') + '://admin:admin@localhost:' + port + '/oxool/getMetrics/';
