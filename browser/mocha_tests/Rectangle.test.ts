...
function assertRectangle(actual: oxool.Rectangle, expected: ExpectedRectangle) {
...
describe('Validity of Rectangle', function () {
	it('Invalid rectangle', function () {
		let invalidRect = new oxool.Rectangle(3, 4, -1, 10);
		assert.ok(!invalidRect.isValid(), 'Rectangle should be invalid');
		invalidRect = new oxool.Rectangle(3, 4, 1, -10);
		assert.ok(!invalidRect.isValid(), 'Rectangle should be invalid');
	});

	it('Valid rectangle', function () {
		const validRect = new oxool.Rectangle(3, 4, 1, 10);
...
describe('construction test', function () {
	it('construct', function () {
		const rect = oxool.createRectangle(x1, y1, width, height);
