...
L.AdminModule.Analytics = L.AdminModule.extend({
	...
	initialize: function() {
		this.sendMessage('subscribe mem_stats cpu_stats sent_activity recv_activity settings');
		this.sendMessage('settings');
		this.sendMessage('sent_activity');
		this.sendMessage('recv_activity');
		this.sendMessage('mem_stats');
		this.sendMessage('cpu_stats');
	},
	...
	terminate: function() {
		this.sendMessage('unsubscribe mem_stats cpu_stats sent_activity recv_activity settings');
