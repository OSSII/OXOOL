...
L.Control.NotebookbarWriter = L.Control.Notebookbar.extend({
	...
	getHelpTab: function() {
		var hasLatestUpdates = false; //window.enableWelcomeMessage;
		var hasFeedback = false; //this._map.feedback;
		var hasAccessibilitySupport = false; //window.enableAccessibility;
