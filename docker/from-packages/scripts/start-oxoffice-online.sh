...
# Start oxoolwsd
exec /usr/bin/oxoolwsd --version --use-env-vars --o:sys_template_path=/opt/oxool/systemplate --o:child_root_path=/opt/oxool/child-roots --o:file_server_root_path=/usr/share/oxoolwsd --o:logging.color=false --o:stop_on_config_change=true ${extra_params}
